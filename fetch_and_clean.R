...
# Load data
df <- read_excel("data/raw/af_data.xlsx",
                 sheet = "1) LEVERANTÖR")
df2 <- read_excel("data/raw/af_data.xlsx",
...
write.csv(df, "data/clean/marketshare.csv", row.names = FALSE)
write.csv(df2, "data/clean/marketshare_municipality.csv", row.names = FALSE)
